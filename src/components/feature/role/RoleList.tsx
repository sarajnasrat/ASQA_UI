...
export const RoleList = () => {
        ...
        <div className="flex flex-col items-center gap-4 p-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">
              {t("role.dialogs.deleteWarning")}
            </p>
          </div>
        </div>
      ),
      header: "",
      acceptLabel: t("role.buttons.delete"),
  ...
  const columns = [
    ...
    {
      header: t("role.columns.roleName"),
      field: "name",
      sortField: "name",
      body: (rowData: any) => (
    ...
    {
      header: t("role.columns.permissions"),
      field: "permissions",
  ...
  const breadcrumbItems = [
    { label: t("nav.dashboard"), icon: "pi pi-home", url: "/" },
    { label: t("role.title"), icon: "pi pi-shield", url: "/roles" },
  ];
