...
const useStatusConfig = (): StatusConfig => {
  ...
  return {
    SUBMITTED: {
      label: t("certificationRequest.statusOptions.public.SUBMITTED"),
      icon: <Clock size={14} />,
      color: "text-blue-600",
      bg: "bg-blue-50",
    },
    STANDARDS_PROVIDED: {
      label: t("certificationRequest.statusOptions.public.STANDARDS_PROVIDED"),
      icon: <FileText size={14} />,
      color: "text-purple-600",
      bg: "bg-purple-50",
    },
    PAYMENT_PENDING: {
      label: t("certificationRequest.statusOptions.public.PAYMENT_PENDING"),
    ...
    REJECTED: {
      label: t("certificationRequest.statusOptions.public.REJECTED"),
      icon: <XCircle size={14} />,
      color: "text-red-600",
      bg: "bg-red-50",
    },
    UNDER_REVIEW: {
      label: t("certificationRequest.statusOptions.public.UNDER_REVIEW"),
      icon: <Clock size={14} />,
      color: "text-yellow-600",
      bg: "bg-yellow-50",
    },
    REGISTERED: {
      label: t("certificationRequest.statusOptions.public.REGISTERED"),
      icon: <CheckCircle2 size={14} />,
      color: "text-green-600",
      bg: "bg-green-50",
    },
    DEADLINE_ASSIGNED: {
      label: t("certificationRequest.statusOptions.public.DEADLINE_ASSIGNED"),
      icon: <AlertCircle size={14} />,
      color: "text-orange-600",
      bg: "bg-orange-50",
    },
    INSPECTION_IN_PROGRESS: {
      label: t("certificationRequest.statusOptions.public.INSPECTION_IN_PROGRESS"),
      icon: <Clock size={14} />,
      color: "text-indigo-600",
      bg: "bg-indigo-50",
    },
    REPORTED_TO_COMMITTEE: {
      label: t("certificationRequest.statusOptions.public.REPORTED_TO_COMMITTEE"),
      icon: <FileText size={14} />,
      color: "text-purple-600",
      bg: "bg-purple-50",
    },
    REPORT_APPROVED: {
      label: t("certificationRequest.statusOptions.public.REPORT_APPROVED"),
      icon: <CheckCircle2 size={14} />,
      color: "text-green-600",
      bg: "bg-green-50",
    },
    PAYMENT_COMPLETED: {
      label: t("certificationRequest.statusOptions.public.PAYMENT_COMPLETED"),
      icon: <CheckCircle2 size={14} />,
      color: "text-green-600",
      bg: "bg-green-50",
    },
    UNDER_SUPERVISION: {
      label: t("certificationRequest.statusOptions.public.UNDER_SUPERVISION"),
      icon: <Clock size={14} />,
      color: "text-blue-600",
      bg: "bg-blue-50",
    },
    CANCELLED: {
      label: t("certificationRequest.statusOptions.public.CANCELLED"),
      icon: <XCircle size={14} />,
      color: "text-gray-600",
      bg: "bg-gray-50",
    },
    DRAFT: {
      label: t("certificationRequest.statusOptions.public.DRAFT"),
      icon: <FileText size={14} />,
      color: "text-gray-600",
      bg: "bg-gray-50",
    },
    DEADLINE_REQUIRED: {
      label: t("certificationRequest.statusOptions.public.DEADLINE_REQUIRED"),
      icon: <AlertCircle size={14} />,
      color: "text-orange-600",
      bg: "bg-orange-50",
    },
